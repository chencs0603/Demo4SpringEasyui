...
public class UserController {
	...
	// 获取当前登录名
	@RequestMapping(value = "/queryCurrentUserName", method = RequestMethod.GET)
	public @ResponseBody String queryCurrentUserName() {
		// Object principal =
	...
	public @ResponseBody String queryByPage(ModelMap model,
